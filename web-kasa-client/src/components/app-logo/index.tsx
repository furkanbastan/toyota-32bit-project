    ...
    <S.AppLogo>
      ...
      >
        <g id="payment-google-wallet">
          <path
            id="path34"
            d="M9.5,10.8C8.1,8.9,6.2,7.3,4.1,6.1C3.8,5.9,3.4,5.8,3,5.8C2.2,5.8,1.4,6.3,1,7c-0.6,1.1-0.2,2.5,0.9,3.1
		c3.3,1.8,5.5,5.2,5.7,9.1l0,0c0-0.4,0-0.9,0.2-1.3c0-0.1,0.1-0.1,0.1-0.2C8.9,16,9.5,14,9.5,12C9.5,11.6,9.5,11.2,9.5,10.8"
          />
          <path
            id="path36"
            d="M22.6,6.5c-0.4-1.8-1-3.5-1.8-5.1C20.4,0.5,19.5,0,18.5,0c-0.4,0-0.7,0.1-1.1,0.2c-1.3,0.6-1.8,2.1-1.2,3.3
		...
		C23.2,10.2,23,8.3,22.6,6.5"
          ...
          <path
            id="path38"
            d="M12,3.9c0-0.1-0.1-0.1-0.1-0.2c-0.2-0.2-0.4-0.4-0.6-0.6c-0.4-0.2-0.8-0.4-1.3-0.4c-0.4,0-0.6,0.1-0.9,0.2
		...
		c0.2,0.1,0.5,0.1,0.7,0.1c0.8,0,1.6-0.4,2-1.1c1.3-2.2,2.1-4.6,2.2-7.1c0-0.3,0-0.7,0-1C14.3,9.1,13.5,6.3,12,3.9"
          ...
          <path
            id="path40"
            d="M16.3,20.4c1.3-2.6,1.9-5.5,1.9-8.4c0-1-0.1-1.7-0.1-2.2c-1.6-2.6-4-5-6.8-6.7c0,0,0.1,0,0.1,0.1
